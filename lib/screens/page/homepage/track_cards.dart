...
class TrackCards extends StatelessWidget {
  ...
  final Future<SpotifyModal> fetchApi;
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                return GestureDetector(
                  onTap: () async {
                    debugPrint(
                        snapshot.data?.tracks?[index].externalUrls?.spotify);
                    String url = snapshot
                            .data?.tracks?[index].externalUrls?.spotify ??
                        ...
                        children: [
                          Container(
                            ...
                            child: ClipRRect(
                              borderRadius: BorderRadius.circular(30),
                              child: Image.network(
                                  snapshot.data?.tracks?[index].album
                                          ?.images?[1].url
                                          .toString() ??
                          ...
                          Padding(
                            ...
                            child: SizedBox(
                              ...
                              child: Row(
                                children: [
                                  Text(
                                      snapshot.data?.tracks?[index].album?.name
                                              .toString() ??
                                          "Unknown Album",
